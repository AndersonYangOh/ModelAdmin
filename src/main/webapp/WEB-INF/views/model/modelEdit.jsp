			...
			<form>
				...
				<div class="biaodan">
					...
					<div class="b-input-text b2">
						<textarea class="form-control" name="scene" id="scene"></textarea>
					</div>
				</div>
				<div class="biaodan">
					<label class="name n2 n1" for="">模型思路：</label>
					<div class="b-input-text b2">
						<textarea class="form-control" name="thinking" id="thinking"></textarea>
					</div>
				</div>
				<div class="biaodan">
				...
				<div class="biaodan">
					...
					<div class="b-input-text b2">
						<textarea class="form-control" name="input" id="input"></textarea>
					</div>
				</div>
				<div class="biaodan b2">
					<label class="name n2 n1" for="">模型输出：</label>
					<div class="b-input-text b2">
						<textarea class="form-control" name="output" id="output"></textarea>
					</div>
				</div>
				<div class="biaodan">
				...
				<div class="biaodan">
					...
					<div class="b-input-text b2">
						<textarea class="form-control" name="advice" id="advice"></textarea>
					</div>
				</div>
				<div class="biaodan">
