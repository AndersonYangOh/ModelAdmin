...
//                 html += "<td>"+period+"</td>";
                ...
                html += '<td>'+
              	...
              	'<a class="btn btn-op" href="model/toModelEdit.do?id='+list[i].id+'" title="修改">修改</a>'+
              	'<a class="btn btn-op" onclick="del('+list[i].id+')" title="删除">删除</a>'+
              	//'<a class="btn btn-op" href="model/toTaskListC.do?id='+list[i].id+'" title="查看进度">查看进度</a>'+
                '</td>';
                html += "</tr>";
            }
            $("#modelList").html(html);
...
<div class="u-body">
	...
	<div class="u-search">
		...
		<div class="button-box-h">
			...
			<a class="button daochu" href="model/toModelAdd.do">新增模型信息</a>
		</div>
	</div>
	<div class="data d2">
