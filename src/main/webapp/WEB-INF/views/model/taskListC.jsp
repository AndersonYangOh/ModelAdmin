	...
	$.ajax({
        ...
        success :function (data) {
            ...
            for(var i in list){
                ...
                html += "<td>"+status+"</td>";
                html += '<td>'+
              	'<a class="btn btn-op" href="model/toTaskDetailListC.do?taskId='+list[i].taskId+'&id='+list[i].id+'" title="查看">查看</a>'+
              	'<a class="btn btn-op" href="model/toMainTaskEdit.do?id='+list[i].id+'&modelId='+list[i].modelId+'" title="修改">修改</a>'+
