...
function getModelList() {
	...
	$.ajax({
        url : "model/getModelListProvince.do",
        type : 'post',
        data :{"name" : name,
                "status" : status,
                "draft" : draft,
        ...
        success :function (data) {
            ...
            for(var i in list){
                ...
                if(list[i].province==null){
                	html += "<td>总部</td>";
                }else{
                    html += "<td>"+list[i].province+"</td>";
                }
...
//                 html += "<td>"+period+"</td>";
                ...
                html += "<td>"+draft+"</td>";
                html += '<td>'+
              	'<a class="btn btn-op" href="model/toModelProvinceCheck.do?id='+list[i].id+'" title="查看">查看</a>'+
              	'<c:if test="${province!=\'001\'}">'+
              	'<a class="btn btn-op" href="model/toModelProvinceEdit.do?id='+list[i].id+'" title="修改">修改</a>'+
...
<div class="u-body">
	...
	<div class="u-search">
		...
		<div class="button-box-h">
			...
			<c:set var="province" scope="page" value="${orgCode}"/>
			<c:if test="${province!='001'}"> 
			<a class="button daochu" href="model/toModelProvinceAdd.do">新增模型信息</a>
			</c:if>
		</div>
	</div>
	<div class="data d2">
