	...
	$.ajax({
        ...
        success :function (data) {
            ...
            for(var i in list){
                ...
                html += "<td>"+status+"</td>";
                //type0全国用户作业角色1作业查看角色
                if (type == '1'){
                	html += '<td>'+
              		'<a class="btn btn-op" href="model/toTaskEdit.do?checkFlag=1&modelId='+list[i].modelId+'&province='+list[i].province+'&id='+list[i].id+'" title="反馈">反馈</a>'+
              		'</td>';
                }else{
                	html += '<td>'+
